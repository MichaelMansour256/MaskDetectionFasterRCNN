    ...
    with open(input_path, 'r') as f:
        ...
        for line in f:
            ...
            if filename not in all_imgs:
                ...
                img = cv2.imread('H:/4.2/4.2/CV/Labs/Lab6/FasterRCNN/dataset/train/images/' + filename)
...
def augment(img_data, config, augment=True):
    ...
    img = cv2.imread('H:/4.2/4.2/CV/Labs/Lab6/FasterRCNN/dataset/train/images/' + img_data_aug['filepath'])
